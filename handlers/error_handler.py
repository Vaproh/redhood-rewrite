...
class ErrorHandler(commands.Cog):
    ...
    async def on_command_error(self, ctx: commands.Context, error):
        ...
        if isinstance(error, commands.EmojiNotFound):
            em = discord.Embed(
                title="Error detected",
                description=f"<:crosss:1212440602659262505>  The Emoji Cannot be found",
                color=config.color_err,
            )
            await ctx.send(embed=em, delete_after=10, mention_author=True)
            await ctx.message.delete(delay=10)
        ...
        if isinstance(error, commands.RoleNotFound):
            em = discord.Embed(
                title="Error detected",
                description=f"<:crosss:1212440602659262505>  The Role Cannot be found",
                color=config.color_err,
            )
            await ctx.send(embed=em, delete_after=10, mention_author=True)
            await ctx.message.delete(delay=10)
        ...
        if isinstance(error, commands.GuildNotFound):
            em = discord.Embed(
                title="Error detected",
                description=f"<:crosss:1212440602659262505>  The Guild Cannot be found",
                color=config.color_err,
            )
            await ctx.send(embed=em, delete_after=10, mention_author=True)
            await ctx.message.delete(delay=10)
        ...
        if isinstance(error, commands.UserNotFound):
            em = discord.Embed(
                title="Error detected",
                description=f"<:crosss:1212440602659262505>  The User Cannot be found",
                color=config.color_err,
            )
            await ctx.send(embed=em, delete_after=10, mention_author=True)
            await ctx.message.delete(delay=10)
        ...
        if isinstance(error, commands.MemberNotFound):
            em = discord.Embed(
                title="Error detected",
                description=f"<:crosss:1212440602659262505>  The Member Cannot be found",
                color=config.color_err,
            )
            await ctx.send(embed=em, delete_after=10, mention_author=True)
            await ctx.message.delete(delay=10)
        ...
        if isinstance(error, commands.NSFWChannelRequired):
            em = discord.Embed(
                title="Error detected",
                description=f"<:crosss:1212440602659262505>  The Channel is required to be NSFW to execute this command",
                color=config.color_err,
            )
            await ctx.send(embed=em, delete_after=10, mention_author=True)
            await ctx.message.delete(delay=10)
